...
class PostUpdateScreen extends StatefulWidget {
  const PostUpdateScreen({Key? key}) : super(key: key);

  @override
  State<PostUpdateScreen> createState() => _CreatePostPageState();
}

class _CreatePostPageState extends State<PostUpdateScreen> {
  //<=============== Data Controllers ========================>
  ...
  PostModel postDetails = Get.arguments;
                    ...
                    child: Focus(
                      ...
                      child: Form(
                        ...
                        child: PostForm(
                          ...
                          buttonText: postDetails.id == 0 ? '' : 'Update',
                              ...
                              if (description.isNotEmpty) {
                                ...
                                if (postController.imageUrl.isNotEmpty) {
                                  ...
                                  await postController.updatePost(
                                    ...
                                    postDetails.amenitiesIconCodes!,
                                    postDetails.amenitiesNames!,
                                    postDetails.categoryId!,
                                    postDetails.subCategoryId!,
                                    postController.isPublished.value,
                                  );
                                  Navigator.pop(context);
                                  postController.getAll();
